...
Slab BoxSlabs[] =
{
	{ -0.2f, -0.2f, -0.2f, 0.2f, 0.2f, 0.2f, Color(128, 128, 128) },
};

SlabModel Boxes = { sizeof(BoxSlabs) / sizeof(Slab), BoxSlabs };
...
void DrawBox(Scene* scene, RenderDevice* render, OculusRoomTinyApp* app)
{
...
void PopulateRoomScene(Scene* scene, RenderDevice* render, OculusRoomTinyApp* app)
{
    FillCollection fills(render);  
